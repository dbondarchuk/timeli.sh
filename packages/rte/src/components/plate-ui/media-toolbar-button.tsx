...
export function MediaToolbarButton({
  ...
  const onAssetSelected = (asset: UploadedFile) => {
  ...
  return (
    <>
        ...
        <DropdownMenu {...openState} modal={false} {...props}>
          ...
          >
            <DropdownMenuGroup>
              ...
              <DropdownMenuItem onSelect={() => setAssetSelectDialogOpen(true)}>
                <PaperclipIcon />
                Select from assets
              </DropdownMenuItem>
      ...
      <AssetSelectorDialog
        isOpen={assetSelectDialogOpen}
        close={() => setAssetSelectDialogOpen(false)}
