...
interface AddVariantButtonProps<T extends BaseStyleDictionary> {
  availableStyles: StyleDictionary<T>;
  onAddVariant: (style: StyleDefinition<T[keyof T]>) => void;
  category?: StyleCategory;
  children?: React.ReactNode;
}

export const AddVariantButton = <T extends BaseStyleDictionary>({
  availableStyles,
  onAddVariant,
